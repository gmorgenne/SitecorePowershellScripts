...
[string]$Region = 'centralus',
 ...
 [Parameter()]
[ValidateNotNullOrEmpty()]
[string]$ResourceGroup = 'sitecore-cus-integration-rg',

 [Parameter()]
[ValidateNotNullOrEmpty()]
[string]$AksName = 'milwaukeeSC-INT',

 [Parameter()]
[ValidateNotNullOrEmpty()]
[string]$AcrName = 'milwaukeeRegINT',
...
$aksVersion = "1.17.13" #$(az aks get-versions -l $Region --query 'orchestrators[-1].orchestratorVersion' -o tsv)
